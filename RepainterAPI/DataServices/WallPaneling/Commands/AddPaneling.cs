        ...
        public async Task<PanelingModel> Handle(AddPaneling request,CancellationToken cancellationToken)
        {
            try
            {
                var paneling = new DataEntities.WallPaneling.Paneling
                {
                    ...
                    PaintingType=request.PanelingModel.PaintingType,
                    PanelingType=request.PanelingModel.PanelingType,
                    TextureType=request.PanelingModel.TextureType,
                    WallPaperType=request.PanelingModel.WallPaperType,
                    Lighting=request.PanelingModel.Lighting,
                    LightingPrice=request.PanelingModel.LightingPrice,
